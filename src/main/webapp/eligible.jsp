...
<br>
	<h3 class="font-weight-light text-center" style="color: teal;">Check
		for which schemes you are eligible</h3>
					...
					<div class="col-md-12">
						<form action="EligibleServlet" method="post">
							...
							<input type="text" class="form-control" id="exampleInputEmail1"
								aria-describedby="emailHelp" name="age" required="required">
					</div>
					<div>
						<br><br>
