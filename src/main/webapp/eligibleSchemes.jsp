...
<body>
	...
	<br>
	<h3 style="color:teal;">You're Eligible for:</h3>
	</div>
...
<%try {
	...
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/wep", "root", "admin");
	 ...
	 */
	 ...
	 while(rs.next())
	 {
		 ...
		 <div class="container offset-md-3 col-md-6 offset-md-3">
		   ...
		   <br>
		   <ul>
			<li><h3><%out.println(rs.getString(1));%></h3></li>
